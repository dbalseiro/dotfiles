class Bitlbee < Formula
  ...
  #dbalseiro: agrego opcion de compular con skype
  option "with-skype", "Se compila con el flag de skype"
  ...
  def install
    ...
    #dbalseiro: compilo con el flag de skype si le da la opcion
    args << "--skype=1" if build.with? "skype"
